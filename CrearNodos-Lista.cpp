...
void lista::Insertar() {
    ...
    cout<<"Nodo Raiz; valor: "<< raiz->valor <<", posicion: "<<raiz<<" ,siguiente: "<< raiz->siguiente<<endl<<endl;
    actual=raiz;
    
	  }else{	
  	hijo= new nodo(valorNodo, NULL);
  	actual->siguiente=hijo;
  	cout<<"Hijo; valor: "<<hijo->valor <<", posicion: "<<hijo<<" ,siguiente: "<< hijo->siguiente<<endl<<endl;
	actual=hijo;
 	 }
